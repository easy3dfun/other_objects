...
hook_standoff_left = 1.8; // Distance the left hooks stand off from the band (gap)
hook_standoff_right= 2; // Distance the right hooks stand off from the band (gap)
hook_length        = 1.6; // How far the hook reaches backward
hook_spacing_angle = 8;   // Distance between first and second hook in degrees
